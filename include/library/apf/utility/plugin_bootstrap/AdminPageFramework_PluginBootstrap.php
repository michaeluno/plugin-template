...
abstract class PluginTemplate_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('PluginTemplate_AdminPageFramework_RegisterClasses', false)) {
            return;
        }
        new PluginTemplate_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
