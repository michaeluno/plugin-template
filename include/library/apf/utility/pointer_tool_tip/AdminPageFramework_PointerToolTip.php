...
class PluginTemplate_AdminPageFramework_PointerToolTip extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    ...
    public function _replyToInsertInternalScript() {
        echo "<script type='text/javascript' class='plugin-template-pointer-tool-tip'>" . '/* <![CDATA[ */' . $this->_getInternalScript(self::$aPointers) . '/* ]]> */' . "</script>";
    }
