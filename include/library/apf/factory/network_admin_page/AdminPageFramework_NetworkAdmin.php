...
abstract class PluginTemplate_AdminPageFramework_NetworkAdmin extends PluginTemplate_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'plugin-template') {
        if (!$this->_isInstantiatable()) {
            return;
        }
        $sCallerPath = $sCallerPath ? $sCallerPath : PluginTemplate_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new PluginTemplate_AdminPageFramework_Model_Menu__RegisterMenu($this, 'network_admin_menu');
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return PluginTemplate_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}
