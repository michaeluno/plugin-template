...
abstract class PluginTemplate_AdminPageFramework_UserMeta_Router extends PluginTemplate_AdminPageFramework_Factory {
...
abstract class PluginTemplate_AdminPageFramework_UserMeta_Model extends PluginTemplate_AdminPageFramework_UserMeta_Router {
    public function _replyToGetSavedFormData() {
        $_iUserID = isset($GLOBALS['profileuser']->ID) ? $GLOBALS['profileuser']->ID : 0;
        $_oMetaData = new PluginTemplate_AdminPageFramework_UserMeta_Model___UserMeta($_iUserID, $this->oForm->aFieldsets);
...
abstract class PluginTemplate_AdminPageFramework_UserMeta_View extends PluginTemplate_AdminPageFramework_UserMeta_Model {
...
abstract class PluginTemplate_AdminPageFramework_UserMeta_Controller extends PluginTemplate_AdminPageFramework_UserMeta_View {
...
abstract class PluginTemplate_AdminPageFramework_UserMeta extends PluginTemplate_AdminPageFramework_UserMeta_Controller {
    protected $_sStructureType = 'user_meta';
    public function __construct($sCapability = 'read', $sTextDomain = 'plugin-template') {
