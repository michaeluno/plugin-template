...
abstract class PluginTemplate_AdminPageFramework_PostType_Router extends PluginTemplate_AdminPageFramework_Factory {
...
abstract class PluginTemplate_AdminPageFramework_PostType_Model extends PluginTemplate_AdminPageFramework_PostType_Router {
    public function __construct($oProp) {
        parent::__construct($oProp);
        ...
        if ($this->oProp->bIsAdmin) {
            ...
            if ($this->oProp->sCallerPath) {
                new PluginTemplate_AdminPageFramework_PostType_Model__FlushRewriteRules($this);
            }
        }
    }
    ...
    public function _replyToRegisterPostType() {
        ...
        new PluginTemplate_AdminPageFramework_PostType_Model__SubMenuOrder($this);
    }
...
abstract class PluginTemplate_AdminPageFramework_PostType_View extends PluginTemplate_AdminPageFramework_PostType_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        if ($this->oProp->bIsAdmin) {
    ...
    public function _replyToPrintStyle() {
        ...
        if (!empty($this->oProp->sStyle)) {
            echo "<style type='text/css' id='plugin-template-style-post-type'>" . $this->oProp->sStyle . "</style>";
        }
    }
...
abstract class PluginTemplate_AdminPageFramework_PostType_Controller extends PluginTemplate_AdminPageFramework_PostType_View {
...
abstract class PluginTemplate_AdminPageFramework_PostType extends PluginTemplate_AdminPageFramework_PostType_Controller {
    protected $_sStructureType = 'post_type';
    public function __construct($sPostType, $aArguments = array(), $sCallerPath = null, $sTextDomain = 'plugin-template') {
        if (empty($sPostType)) {
            return;
        }
        ...
        $this->oProp->sPostType = PluginTemplate_AdminPageFramework_WPUtility::sanitizeSlug($sPostType);
        $this->oProp->aPostTypeArgs = $aArguments;
    ...
    private function _getCallerScriptPath($sCallerPath) {
        ...
        $_sPageNow = PluginTemplate_AdminPageFramework_Utility::getElement($GLOBALS, 'pagenow');
        if (in_array($_sPageNow, array('edit.php', 'post.php', 'post-new.php', 'plugins.php', 'tags.php', 'edit-tags.php', 'term.php'))) {
            return PluginTemplate_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        }
        return null;
    }
}
