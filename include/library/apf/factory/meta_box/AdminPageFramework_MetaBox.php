...
abstract class PluginTemplate_AdminPageFramework_MetaBox_Router extends PluginTemplate_AdminPageFramework_Factory {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'plugin-template') {
...
abstract class PluginTemplate_AdminPageFramework_MetaBox_Model extends PluginTemplate_AdminPageFramework_MetaBox_Router {
    public function __construct($sMetaBoxID, $sTitle, $asPostTypeOrScreenID = array('post'), $sContext = 'normal', $sPriority = 'default', $sCapability = 'edit_posts', $sTextDomain = 'plugin-template') {
    ...
    public function _replyToGetSavedFormData() {
        $_oMetaData = new PluginTemplate_AdminPageFramework_MetaBox_Model___PostMeta($this->_getPostID(), $this->oForm->aFieldsets);
...
abstract class PluginTemplate_AdminPageFramework_MetaBox_View extends PluginTemplate_AdminPageFramework_MetaBox_Model {
...
abstract class PluginTemplate_AdminPageFramework_MetaBox_Controller extends PluginTemplate_AdminPageFramework_MetaBox_View {
...
abstract class PluginTemplate_AdminPageFramework_MetaBox extends PluginTemplate_AdminPageFramework_MetaBox_Controller {
