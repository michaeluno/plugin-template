...
class PluginTemplate_AdminPageFramework_Property_post_meta_box extends PluginTemplate_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sClassName, $sCapability = 'edit_posts', $sTextDomain = 'plugin-template', $sStructureType = 'post_meta_box') {
