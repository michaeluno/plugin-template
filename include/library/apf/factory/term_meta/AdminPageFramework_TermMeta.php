...
abstract class PluginTemplate_AdminPageFramework_TermMeta_Router extends PluginTemplate_AdminPageFramework_TaxonomyField_Controller {
}
abstract class PluginTemplate_AdminPageFramework_TermMeta_Model extends PluginTemplate_AdminPageFramework_TermMeta_Router {
    ...
    private function _getSavedTermMetas($iTermID, array $aFieldsets) {
        $_oMetaData = new PluginTemplate_AdminPageFramework_TermMeta_Model___TermMeta($iTermID, $this->oForm->aFieldsets);
...
abstract class PluginTemplate_AdminPageFramework_TermMeta_View extends PluginTemplate_AdminPageFramework_TermMeta_Model {
...
abstract class PluginTemplate_AdminPageFramework_TermMeta_Controller extends PluginTemplate_AdminPageFramework_TermMeta_View {
}
abstract class PluginTemplate_AdminPageFramework_TermMeta extends PluginTemplate_AdminPageFramework_TermMeta_Controller {
    protected $_sStructureType = 'term_meta';
    public function __construct($asTaxonomySlug, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
