...
abstract class PluginTemplate_AdminPageFramework_TaxonomyField_Router extends PluginTemplate_AdminPageFramework_Factory {
...
abstract class PluginTemplate_AdminPageFramework_TaxonomyField_Model extends PluginTemplate_AdminPageFramework_TaxonomyField_Router {
...
abstract class PluginTemplate_AdminPageFramework_TaxonomyField_View extends PluginTemplate_AdminPageFramework_TaxonomyField_Model {
...
abstract class PluginTemplate_AdminPageFramework_TaxonomyField_Controller extends PluginTemplate_AdminPageFramework_TaxonomyField_View {
    public function setUp() {
    }
}
abstract class PluginTemplate_AdminPageFramework_TaxonomyField extends PluginTemplate_AdminPageFramework_TaxonomyField_Controller {
    protected $_sStructureType = 'taxonomy_field';
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
