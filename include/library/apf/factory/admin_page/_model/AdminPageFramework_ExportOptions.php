...
abstract class PluginTemplate_AdminPageFramework_CustomSubmitFields extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    public $aPost = array();
    public $sInputID;
...
class PluginTemplate_AdminPageFramework_ExportOptions extends PluginTemplate_AdminPageFramework_CustomSubmitFields {
    public $sClassName;
    public $sFileName;
    public $sFormatType;
    public $bIsDataSet;
        ...
        switch (strtolower($sFormatType)) {
            case 'text':
                if (in_array(gettype($vData), array('array', 'object'))) {
                    echo PluginTemplate_AdminPageFramework_Debug::get($vData, null, false);
                }
                echo $vData;
                return;
            case 'json':
