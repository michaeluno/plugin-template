...
class PluginTemplate_AdminPageFramework_Property_admin_page extends PluginTemplate_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $aisOptionKey, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
        ...
        $GLOBALS['aPluginTemplate_AdminPageFramework']['aPageClasses'] = $this->getElementAsArray($GLOBALS, array('aPluginTemplate_AdminPageFramework', 'aPageClasses'));
        $GLOBALS['aPluginTemplate_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
