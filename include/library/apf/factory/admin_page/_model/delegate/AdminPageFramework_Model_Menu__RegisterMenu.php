...
class PluginTemplate_AdminPageFramework_Model_Menu__RegisterMenu extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    public $oFactory;
    ...
    public function _replyToRegisterSubMenuItems() {
        ...
        foreach ($_aPages as $_aSubMenuItem) {
            $_oFormatter = new PluginTemplate_AdminPageFramework_Format_SubMenuItem($_aSubMenuItem, $this->oFactory, ++$_iParsedIndex);
