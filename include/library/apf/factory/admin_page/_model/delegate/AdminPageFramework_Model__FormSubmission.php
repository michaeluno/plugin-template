...
abstract class PluginTemplate_AdminPageFramework_Model__FormSubmission_Base extends PluginTemplate_AdminPageFramework_FrameworkUtility {
...
class PluginTemplate_AdminPageFramework_Model__FormSubmission extends PluginTemplate_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
    public function __construct($oFactory, $aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        $this->oFactory = $oFactory;
        $this->_handleFormData();
        new PluginTemplate_AdminPageFramework_Model__FormRedirectHandler($oFactory);
    }
    public function _handleFormData() {
        ...
        new PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator($this->oFactory);
