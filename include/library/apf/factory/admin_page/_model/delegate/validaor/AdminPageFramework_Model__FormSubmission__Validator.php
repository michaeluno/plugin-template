...
class PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator_Base extends PluginTemplate_AdminPageFramework_Model__FormSubmission_Base {
    public $oFactory;
...
class PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator extends PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator_Base {
    public $oFactory;
    ...
    public function _replyToValidateUserFormInputs($aInputs, $aRawInputs, $aOptions, $oFactory) {
        ...
        $_aClassNames = array('PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Link', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Redirect', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Import', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Export', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Reset', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__ResetConfirm', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__ContactForm', 'PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__ContactFormConfirm',);
        ...
        try {
            ...
            $_oFormSubmissionFilter = new PluginTemplate_AdminPageFramework_Model__FormSubmission__Validator__Filter($this->oFactory, $aInputs, $aRawInputs, $aOptions, $_aSubmitsInformation);
