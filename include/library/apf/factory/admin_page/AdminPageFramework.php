...
abstract class PluginTemplate_AdminPageFramework_Router extends PluginTemplate_AdminPageFramework_Factory {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
        $_sProprtyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'PluginTemplate_AdminPageFramework_Property_' . $this->_sStructureType;
    ...
    public function _replyToLoadComponentsForAjax() {
        ...
        new PluginTemplate_AdminPageFramework_Model_Menu__RegisterMenu($this, 'pseudo_admin_menu');
...
abstract class PluginTemplate_AdminPageFramework_Model_Form extends PluginTemplate_AdminPageFramework_Router {
    public $aFieldErrors;
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
        ...
        new PluginTemplate_AdminPageFramework_Model__FormEmailHandler($this);
    ...
    public function _replyToHandleSubmittedFormData($aSavedData, $aArguments, $aSectionsets, $aFieldsets) {
        new PluginTemplate_AdminPageFramework_Model__FormSubmission($this, $aSavedData, $aArguments, $aSectionsets, $aFieldsets);
    }
...
abstract class PluginTemplate_AdminPageFramework_View_Form extends PluginTemplate_AdminPageFramework_Model_Form {
...
abstract class PluginTemplate_AdminPageFramework_Controller_Form extends PluginTemplate_AdminPageFramework_View_Form {
    ...
    public function getValue() {
        ...
        return PluginTemplate_AdminPageFramework_WPUtility::getOption($this->oProp->sOptionKey, empty($_aParams) ? null : $_aDimensionalKeys, $_mDefault, $this->getSavedOptions() + $this->oForm->getDefaultFormValues());
    }
...
abstract class PluginTemplate_AdminPageFramework_Model_Page extends PluginTemplate_AdminPageFramework_Controller_Form {
    public function _replyToFinalizeInPageTabs() {
        ...
        foreach ($this->oProp->aPages as $_sPageSlug => $_aPage) {
            ...
            $_oFormatter = new PluginTemplate_AdminPageFramework_Format_InPageTabs($this->oProp->aInPageTabs[$_sPageSlug], $_sPageSlug, $this);
...
abstract class PluginTemplate_AdminPageFramework_View_Page extends PluginTemplate_AdminPageFramework_Model_Page {
    public function _replyToEnablePageMetaBoxes() {
        new PluginTemplate_AdminPageFramework_View__PageMetaboxEnabler($this);
    }
    public function _replyToEnqueuePageAssets() {
        new PluginTemplate_AdminPageFramework_View__Resource($this);
    }
    ...
    protected function _renderPage($sPageSlug, $sTabSlug = null) {
        $_oPageRenderer = new PluginTemplate_AdminPageFramework_View__PageRenderer($this, $sPageSlug, $sTabSlug);
        $_oPageRenderer->render();
    }
}
abstract class PluginTemplate_AdminPageFramework_Controller_Page extends PluginTemplate_AdminPageFramework_View_Page {
...
abstract class PluginTemplate_AdminPageFramework_Model_Menu extends PluginTemplate_AdminPageFramework_Controller_Page {
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
        parent::__construct($sOptionKey, $sCallerPath, $sCapability, $sTextDomain);
        new PluginTemplate_AdminPageFramework_Model_Menu__RegisterMenu($this);
    }
}
abstract class PluginTemplate_AdminPageFramework_View_Menu extends PluginTemplate_AdminPageFramework_Model_Menu {
}
abstract class PluginTemplate_AdminPageFramework_Controller_Menu extends PluginTemplate_AdminPageFramework_View_Menu {
    ...
    public function addSubMenuLink(array $aSubMenuLink) {
        ...
        $_oFormatter = new PluginTemplate_AdminPageFramework_Format_SubMenuLink($aSubMenuLink, $this, count($this->oProp->aPages) + 1);
    ...
    public function addSubMenuPage(array $aSubMenuPage) {
        ...
        $_oFormatter = new PluginTemplate_AdminPageFramework_Format_SubMenuPage($aSubMenuPage, $this, count($this->oProp->aPages) + 1);
        $_aSubMenuPage = $_oFormatter->get();
        $this->oProp->aPages[$_aSubMenuPage['page_slug']] = $_aSubMenuPage;
    }
}
abstract class PluginTemplate_AdminPageFramework_Model extends PluginTemplate_AdminPageFramework_Controller_Menu {
}
abstract class PluginTemplate_AdminPageFramework_View extends PluginTemplate_AdminPageFramework_Model {
    public function content($sContent) {
        return $sContent;
    }
}
abstract class PluginTemplate_AdminPageFramework_Controller extends PluginTemplate_AdminPageFramework_View {
    ...
    public function setAdminNotice($sMessage, $sClassSelector = 'error', $sID = '') {
        ...
        new PluginTemplate_AdminPageFramework_AdminNotice($this->oProp->aAdminNotices[$sID]['sMessage'], $this->oProp->aAdminNotices[$sID]['aAttributes'], array('should_show' => array($this, 'isInThePage'),));
    }
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return PluginTemplate_AdminPageFramework_WPUtility::getOption($sOptionKey, $asKey, $vDefault);
    }
}
abstract class PluginTemplate_AdminPageFramework extends PluginTemplate_AdminPageFramework_Controller {
    protected $_sStructureType = 'admin_page';
    public function __construct($isOptionKey = null, $sCallerPath = null, $sCapability = 'manage_options', $sTextDomain = 'plugin-template') {
    ...
    private function _getCallerPath($sCallerPath) {
        ...
        $_sCalllerPath = in_array($GLOBALS['pagenow'], array('plugins.php',)) || isset($_GET['page']) ? PluginTemplate_AdminPageFramework_Utility::getCallerScriptPath(__FILE__) : null;
