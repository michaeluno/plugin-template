...
abstract class PluginTemplate_AdminPageFramework_PageLoadInfo_Base extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    public $oProp;
    public $oMsg;
