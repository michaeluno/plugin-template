...
abstract class PluginTemplate_AdminPageFramework_Property_Base extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sStructureType) {
        ...
        $this->sTextDomain = empty($sTextDomain) ? 'plugin-template' : $sTextDomain;
    ...
    private function _setGlobals() {
        if (!isset($GLOBALS['aPluginTemplate_AdminPageFramework'])) {
            $GLOBALS['aPluginTemplate_AdminPageFramework'] = array('aFieldFlags' => array());
        }
    }
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => PluginTemplate_AdminPageFramework_Registry::NAME, 'sURI' => PluginTemplate_AdminPageFramework_Registry::URI, 'sScriptName' => PluginTemplate_AdminPageFramework_Registry::NAME, 'sLibraryName' => PluginTemplate_AdminPageFramework_Registry::NAME, 'sLibraryURI' => PluginTemplate_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => PluginTemplate_AdminPageFramework_Registry::getVersion(), 'sDescription' => PluginTemplate_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => PluginTemplate_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => PluginTemplate_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => PluginTemplate_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => PluginTemplate_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        ...
        if ('oUtil' === $sName) {
            $this->oUtil = new PluginTemplate_AdminPageFramework_WPUtility;
            return $this->oUtil;
        }
    }
}
