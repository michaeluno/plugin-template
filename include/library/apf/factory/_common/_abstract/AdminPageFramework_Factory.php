...
abstract class PluginTemplate_AdminPageFramework_Factory_Router {
    public $oProp;
    public $oDebug;
    public $oUtil;
    public $oMsg;
    ...
    protected $oHelpPane;
    protected $oLink;
    protected $_aSubClassPrefixes = array('oForm' => 'PluginTemplate_AdminPageFramework_Form_', 'oPageLoadInfo' => 'PluginTemplate_AdminPageFramework_PageLoadInfo_', 'oResource' => 'PluginTemplate_AdminPageFramework_Resource_', 'oHelpPane' => 'PluginTemplate_AdminPageFramework_HelpPane_', 'oLink' => 'PluginTemplate_AdminPageFramework_Link_',);
    private $_aSubClassNames = array('oProp' => null, 'oDebug' => 'PluginTemplate_AdminPageFramework_Debug', 'oUtil' => 'PluginTemplate_AdminPageFramework_FrameworkUtility', 'oMsg' => 'PluginTemplate_AdminPageFramework_Message', 'oForm' => null, 'oPageLoadInfo' => null, 'oResource' => null, 'oHelpPane' => null, 'oLink' => null,);
    ...
    private function _triggerUndefinedMethodWarning($sMethodName) {
        trigger_error(PluginTemplate_AdminPageFramework_Registry::NAME . ': ' . sprintf(__('The method is not defined: %1$s', $this->oProp->sTextDomain), $sMethodName), E_USER_WARNING);
    }
    public function __toString() {
        return PluginTemplate_AdminPageFramework_FrameworkUtility::getObjectInfo($this);
    }
...
abstract class PluginTemplate_AdminPageFramework_Factory_Model extends PluginTemplate_AdminPageFramework_Factory_Router {
    public function __construct($oProp) {
...
abstract class PluginTemplate_AdminPageFramework_Factory_View extends PluginTemplate_AdminPageFramework_Factory_Model {
    public function __construct($oProp) {
        parent::__construct($oProp);
        new PluginTemplate_AdminPageFramework_Factory_View__SettingNotice($this, $this->oProp->sSettingNoticeActionHook);
    }
...
abstract class PluginTemplate_AdminPageFramework_Factory_Controller extends PluginTemplate_AdminPageFramework_Factory_View {
...
abstract class PluginTemplate_AdminPageFramework_Factory extends PluginTemplate_AdminPageFramework_Factory_Controller {
}
