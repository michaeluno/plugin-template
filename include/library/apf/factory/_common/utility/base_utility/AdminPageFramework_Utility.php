...
abstract class PluginTemplate_AdminPageFramework_Utility_Deprecated {
    static public function minifyCSS($sCSSRules) {
        PluginTemplate_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getCSSMinified()');
        return PluginTemplate_AdminPageFramework_Utility_String::getCSSMinified($sCSSRules);
    }
    static public function sanitizeLength($sLength, $sUnit = 'px') {
        PluginTemplate_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getLengthSanitized()');
        return PluginTemplate_AdminPageFramework_Utility_String::getLengthSanitized($sLength, $sUnit);
    }
    public static function getCorrespondingArrayValue($vSubject, $sKey, $sDefault = '', $bBlankToDefault = false) {
        PluginTemplate_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__, 'getElement()');
        if (!isset($vSubject)) {
            return $sDefault;
        }
    ...
    static public function isAssociativeArray(array $aArray) {
        PluginTemplate_AdminPageFramework_Utility::showDeprecationNotice(__FUNCTION__);
    ...
    static public function getAttributes(array $aAttributes) {
        PluginTemplate_AdminPageFramework_Utility::showDeprecationNotice(__METHOD__, 'PluginTemplate_AdminPageFramework_WPUtility::getAttributes()');
        $_sQuoteCharactor = "'";
        $_aOutput = array();
...
abstract class PluginTemplate_AdminPageFramework_Utility_VariableType extends PluginTemplate_AdminPageFramework_Utility_Deprecated {
...
abstract class PluginTemplate_AdminPageFramework_Utility_String extends PluginTemplate_AdminPageFramework_Utility_VariableType {
...
abstract class PluginTemplate_AdminPageFramework_Utility_Array extends PluginTemplate_AdminPageFramework_Utility_String {
...
abstract class PluginTemplate_AdminPageFramework_Utility_ArrayGetter extends PluginTemplate_AdminPageFramework_Utility_Array {
...
abstract class PluginTemplate_AdminPageFramework_Utility_ArraySetter extends PluginTemplate_AdminPageFramework_Utility_ArrayGetter {
...
abstract class PluginTemplate_AdminPageFramework_Utility_Path extends PluginTemplate_AdminPageFramework_Utility_ArraySetter {
...
abstract class PluginTemplate_AdminPageFramework_Utility_URL extends PluginTemplate_AdminPageFramework_Utility_Path {
...
abstract class PluginTemplate_AdminPageFramework_Utility_File extends PluginTemplate_AdminPageFramework_Utility_URL {
...
abstract class PluginTemplate_AdminPageFramework_Utility_SystemInformation extends PluginTemplate_AdminPageFramework_Utility_File {
...
abstract class PluginTemplate_AdminPageFramework_Utility_HTMLAttribute extends PluginTemplate_AdminPageFramework_Utility_SystemInformation {
...
class PluginTemplate_AdminPageFramework_Utility extends PluginTemplate_AdminPageFramework_Utility_HTMLAttribute {
