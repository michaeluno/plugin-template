...
class PluginTemplate_AdminPageFramework_FrameworkUtility extends PluginTemplate_AdminPageFramework_WPUtility {
    ...
    static public function getFrameworkVersion($bTrimDevVer = false) {
        $_sVersion = PluginTemplate_AdminPageFramework_Registry::getVersion();
        return $bTrimDevVer ? self::getSuffixRemoved($_sVersion, '.dev') : $_sVersion;
    }
    static public function getFrameworkName() {
        return PluginTemplate_AdminPageFramework_Registry::NAME;
    }
    static public function getFrameworkNameVersion() {
        return self::getFrameworkName() . ' ' . self::getFrameworkVersion();
    }
}
class PluginTemplate_AdminPageFramework_ArrayHandler extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    public $aData = array();
