...
class PluginTemplate_AdminPageFramework_AdminNotice extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct($sNotice, array $aAttributes = array('class' => 'error'), array $aCallbacks = array()) {
        ...
        $this->aAttributes['class'] = $this->getClassAttribute($this->aAttributes['class'], 'plugin-template-settings-notice-message', 'plugin-template-settings-notice-container', 'notice', 'is-dismissible');
        $this->aCallbacks = $aCallbacks + $this->aCallbacks;
        new PluginTemplate_AdminPageFramework_AdminNotice___Script;
        if (!$sNotice) {
            return;
        }
