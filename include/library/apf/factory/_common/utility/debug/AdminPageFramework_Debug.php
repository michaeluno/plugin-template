...
class PluginTemplate_AdminPageFramework_Debug_Base extends PluginTemplate_AdminPageFramework_FrameworkUtility {
...
class PluginTemplate_AdminPageFramework_Debug_Log extends PluginTemplate_AdminPageFramework_Debug_Base {
...
class PluginTemplate_AdminPageFramework_Debug extends PluginTemplate_AdminPageFramework_Debug_Log {
    ...
    static public function dumpArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('PluginTemplate_AdminPageFramework_Debug::' . __FUNCTION__, 'PluginTemplate_AdminPageFramework_Debug::dump()');
        PluginTemplate_AdminPageFramework_Debug::dump($asArray, $sFilePath);
    }
    static public function getArray($asArray, $sFilePath = null, $bEscape = true) {
        self::showDeprecationNotice('PluginTemplate_AdminPageFramework_Debug::' . __FUNCTION__, 'PluginTemplate_AdminPageFramework_Debug::get()');
        return PluginTemplate_AdminPageFramework_Debug::get($asArray, $sFilePath, $bEscape);
    }
    static public function logArray($asArray, $sFilePath = null) {
        self::showDeprecationNotice('PluginTemplate_AdminPageFramework_Debug::' . __FUNCTION__, 'PluginTemplate_AdminPageFramework_Debug::log()');
        PluginTemplate_AdminPageFramework_Debug::log($asArray, $sFilePath);
    }
    static public function getAsString($mValue) {
        self::showDeprecationNotice('PluginTemplate_AdminPageFramework_Debug::' . __FUNCTION__);
