...
class PluginTemplate_AdminPageFramework_Form_Model___Format_RepeatableSection extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    ...
    public function __construct() {
        ...
        $this->_oMsg = $_aParameters[1] ? $_aParameters[1] : PluginTemplate_AdminPageFramework_Message::getInstance();
    }
    public function get() {
...
class PluginTemplate_AdminPageFramework_Form_Model___Format_RepeatableField extends PluginTemplate_AdminPageFramework_Form_Model___Format_RepeatableSection {
    protected function _getDefaultMessage() {
