...
abstract class PluginTemplate_AdminPageFramework_Input_Base extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    public $aField = array();
    public $aAttributes = array();
    public $aOptions = array();
    public $aStructureOptions = array('input_container_tag' => 'span', 'input_container_attributes' => array('class' => 'plugin-template-input-container',), 'label_container_tag' => 'span', 'label_container_attributes' => array('class' => 'plugin-template-input-label-string',),);
...
class PluginTemplate_AdminPageFramework_Input_checkbox extends PluginTemplate_AdminPageFramework_Input_Base {
