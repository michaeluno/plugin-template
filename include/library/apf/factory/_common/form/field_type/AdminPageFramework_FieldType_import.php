...
class PluginTemplate_AdminPageFramework_FieldType_import extends PluginTemplate_AdminPageFramework_FieldType_submit {
    ...
    protected function getStyles() {
        return ".plugin-template-field-import input {margin-right: 0.5em;}.plugin-template-field-import label,.form-table td fieldset.plugin-template-fieldset .plugin-template-field-import label { display: inline; }";
    }
