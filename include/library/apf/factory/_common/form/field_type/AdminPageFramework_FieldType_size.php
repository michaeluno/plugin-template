...
class PluginTemplate_AdminPageFramework_FieldType_size extends PluginTemplate_AdminPageFramework_FieldType_select {
    ...
    protected function getStyles() {
        return ".plugin-template-field-size input {text-align: right;}.plugin-template-field-size select.size-field-select {vertical-align: 0px; }.plugin-template-field-size label {width: auto; } .form-table td fieldset .plugin-template-field-size label {display: inline;}";
    }
    protected function getField($aField) {
