...
abstract class PluginTemplate_AdminPageFramework_FieldType_Base extends PluginTemplate_AdminPageFramework_Form_Utility {
    ...
    protected function getFieldOutput(array $aFieldset) {
        ...
        $_oFieldset = new PluginTemplate_AdminPageFramework_Form_View___Fieldset($aFieldset, $_oCallerForm->aSavedData, $_oCallerForm->getFieldErrors(), $_oCallerForm->aFieldTypeDefinitions, $_oCallerForm->oMsg, $_oCallerForm->aCallbacks);
    ...
    protected function enqueueMediaUploader() {
        ...
        if (function_exists('wp_enqueue_media')) {
            new PluginTemplate_AdminPageFramework_Form_View___Script_MediaUploader($this->oMsg);
        } else {
...
abstract class PluginTemplate_AdminPageFramework_FieldType extends PluginTemplate_AdminPageFramework_FieldType_Base {
    public function _replyToFieldLoader() {
        $this->setUp();
    }
    public function _replyToGetScripts() {
...
class PluginTemplate_AdminPageFramework_FieldType_color extends PluginTemplate_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".repeatable .colorpicker {display: inline;}.plugin-template-field-color .wp-picker-container {vertical-align: middle;}.plugin-template-field-color .ui-widget-content {border: none;background: none;color: transparent;}.plugin-template-field-color .ui-slider-vertical {width: inherit;height: auto;margin-top: -11px;}.plugin-template-field-color .plugin-template-repeatable-field-buttons {margin-top: 0;}.plugin-template-field-color .wp-color-result {margin: 3px;}";
    }
    protected function getScripts() {
        $_aJSArray = json_encode($this->aFieldTypeSlugs);
        $_sDoubleQuote = '\"';
        return <<<JAVASCRIPTS
registerPluginTemplate_AdminPageFrameworkColorPickerField = function( osTragetInput, aOptions ) {
    ...
    var _aDefaults = {
        ...
        change: function( event, ui ){
            jQuery( this ).trigger( 
                'plugin-template_field_type_color_changed',
        ...
        clear: function( event, ui ) {
            jQuery( this ).trigger(
                'plugin-template_field_type_color_cleared',
    ...
    jQuery().registerPluginTemplate_AdminPageFrameworkCallbacks( {     
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( 'input.input_color' ).each( function( iIterationIndex ) {
                ...
                registerPluginTemplate_AdminPageFrameworkColorPickerField( _oNewColorInput );                
...
JAVASCRIPTS;
    ...
    protected function getField($aField) {
        ...
        return $aField['before_label'] . "<div class='plugin-template-input-label-container'>" . "<label for='{$aField['input_id']}'>" . $aField['before_input'] . ($aField['label'] && !$aField['repeatable'] ? "<span " . $this->getLabelContainerAttributes($aField, 'plugin-template-input-label-string') . ">" . $aField['label'] . "</span>" : "") . "<input " . $this->getAttributes($aField['attributes']) . " />" . $aField['after_input'] . "<div class='repeatable-field-buttons'></div>" . "</label>" . "<div class='colorpicker' id='color_{$aField['input_id']}'></div>" . $this->_getColorPickerEnablerScript("{$aField['input_id']}") . "</div>" . $aField['after_label'];
    }
...
jQuery( document ).ready( function(){
    registerPluginTemplate_AdminPageFrameworkColorPickerField( '{$sInputID}' );
});            
JAVASCRIPTS;
