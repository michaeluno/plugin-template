...
class PluginTemplate_AdminPageFramework_FieldType_submit extends PluginTemplate_AdminPageFramework_FieldType {
    ...
    protected function getStyles() {
        return ".plugin-template-field input[type='submit'] {margin-bottom: 0.5em;}";
    }
    ...
    private function _getLabelContainerAttributes(array $aField) {
        return array('style' => $aField['label_min_width'] || '0' === ( string )$aField['label_min_width'] ? "min-width:" . $this->getLengthSanitized($aField['label_min_width']) . ";" : null, 'class' => 'plugin-template-input-label-container' . ' plugin-template-input-button-container' . ' plugin-template-input-container',);
    }
...
class PluginTemplate_AdminPageFramework_FieldType_export extends PluginTemplate_AdminPageFramework_FieldType_submit {
