...
class PluginTemplate_AdminPageFramework_FieldType_checkbox extends PluginTemplate_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getSelectButtonClassSelectors(array $aFieldTypeSlugs, $sDataAttribute = 'select_all_button') {
        ...
        foreach ($aFieldTypeSlugs as $_sSlug) {
            ...
            $_aClassSelectors[] = '.plugin-template-checkbox-container-' . $_sSlug . "[data-{$sDataAttribute}]";
        }
        return implode(',', $_aClassSelectors);
    }
    protected function getStyles() {
        return ".select_all_button_container, .select_none_button_container{display: inline-block;margin-bottom: 0.4em;}.plugin-template-checkbox-label {margin-top: 0.1em;}.plugin-template-field input[type='checkbox' ] {margin-right: 0.5em;} .plugin-template-field-checkbox .plugin-template-input-label-container {padding-right: 1em;}.plugin-template-field-checkbox .plugin-template-input-label-string{display: inline; }";
    }
...
class PluginTemplate_AdminPageFramework_FieldType_posttype extends PluginTemplate_AdminPageFramework_FieldType_checkbox {
    ...
    protected function getStyles() {
        ...
        return $_sParentStyles . ".plugin-template-field input[type='checkbox'] {margin-right: 0.5em;} .plugin-template-field-posttype .plugin-template-input-label-container {padding-right: 1em;}";
    }
    protected function getField($aField) {
