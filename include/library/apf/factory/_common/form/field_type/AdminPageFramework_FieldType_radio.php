...
class PluginTemplate_AdminPageFramework_FieldType_radio extends PluginTemplate_AdminPageFramework_FieldType {
    public $aFieldTypeSlugs = array('radio');
    protected $aDefaultKeys = array('label' => array(), 'attributes' => array(),);
    protected function getStyles() {
        return ".plugin-template-field input[type='radio'] {margin-right: 0.5em;} .plugin-template-field-radio .plugin-template-input-label-container {padding-right: 1em;} .plugin-template-field-radio .plugin-template-input-container {display: inline;} .plugin-template-field-radio .plugin-template-input-label-string{display: inline; }";
    }
...
jQuery( document ).ready( function(){
    jQuery( 'input[type=radio][data-id=\"{$sInputID}\"]' ).change( function() {
        ...
        jQuery( this ).closest( '.plugin-template-field' ).find( 'input[type=radio][data-id=\"{$sInputID}\"]' ).attr( 'checked', false );
