...
class PluginTemplate_AdminPageFramework_Form_View___DebugInfo extends PluginTemplate_AdminPageFramework_FrameworkUtility {
    ...
    public function get() {
        ...
        return "<div class='plugin-template-info'>" . $this->oMsg->get('debug_info') . ': ' . $this->getFrameworkNameVersion() . "</div>";
    }
