...
class PluginTemplate_AdminPageFramework_Form_View___Generate_FieldTagID extends PluginTemplate_AdminPageFramework_Form_View___Generate_Field_Base {
    public function get() {
...
class PluginTemplate_AdminPageFramework_Form_View___Generate_FieldInputID extends PluginTemplate_AdminPageFramework_Form_View___Generate_FieldTagID {
    public $isIndex = '';
