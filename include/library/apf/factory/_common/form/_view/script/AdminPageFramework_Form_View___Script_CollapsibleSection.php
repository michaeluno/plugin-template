...
( function( $ ) {
    ...
    $.fn.initializePluginTemplate_AdminPageFrameworkCollapsibleSections = function() {
        ...
        jQuery( this ).find( '.plugin-template-collapsible-sections-title, .plugin-template-collapsible-section-title' ).enablePluginTemplate_AdminPageFrameworkCollapsibleButton();
