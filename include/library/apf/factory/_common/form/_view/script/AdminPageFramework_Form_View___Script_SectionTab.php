...
class PluginTemplate_AdminPageFramework_Form_View___Script_SectionTab extends PluginTemplate_AdminPageFramework_Form_View___Script_Base {
...
jQuery( '.plugin-template-section-tabs-contents' ).createTabs(); 
});            
JAVASCRIPTS;
        return "<script type='text/javascript' class='plugin-template-section-tabs-script'>" . '/* <![CDATA[ */' . $_sScript . '/* ]]> */' . "</script>";
    }
}
