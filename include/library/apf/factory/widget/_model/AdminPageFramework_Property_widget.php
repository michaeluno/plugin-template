...
class PluginTemplate_AdminPageFramework_Property_widget extends PluginTemplate_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'plugin-template', $sStructureType) {
