...
abstract class PluginTemplate_AdminPageFramework_Widget_Router extends PluginTemplate_AdminPageFramework_Factory {
...
abstract class PluginTemplate_AdminPageFramework_Widget_Model extends PluginTemplate_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $wp_widget_factory->widgets[$this->oProp->sClassName] = new PluginTemplate_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
        $this->oProp->oWidget = $wp_widget_factory->widgets[$this->oProp->sClassName];
    }
}
abstract class PluginTemplate_AdminPageFramework_Widget_View extends PluginTemplate_AdminPageFramework_Widget_Model {
...
abstract class PluginTemplate_AdminPageFramework_Widget_Controller extends PluginTemplate_AdminPageFramework_Widget_View {
...
abstract class PluginTemplate_AdminPageFramework_Widget extends PluginTemplate_AdminPageFramework_Widget_Controller {
    protected $_sStructureType = 'widget';
    public function __construct($sWidgetTitle, $aWidgetArguments = array(), $sCapability = 'edit_theme_options', $sTextDomain = 'plugin-template') {
