...
abstract class PluginTemplate_AdminPageFramework_Widget_Model extends PluginTemplate_AdminPageFramework_Widget_Router {
    ...
    public function _replyToRegisterWidget() {
        ...
        $GLOBALS['wp_widget_factory']->widgets[$this->oProp->sClassName] = new PluginTemplate_AdminPageFramework_Widget_Factory($this, $this->oProp->sWidgetTitle, $this->oUtil->getAsArray($this->oProp->aWidgetArguments));
...
abstract class PluginTemplate_AdminPageFramework_Widget extends PluginTemplate_AdminPageFramework_Widget_Controller {
    ...
    public function __construct() {
        ...
        $_aDefaults = array('', array(), 'edit_theme_options', 'plugin-template');
    ...
    private function ___setProperties($aParameters, $sThisClassName, $_bAssumedAsWPWidget) {
        ...
        $_sPropertyClassName = isset($this->aSubClassNames['oProp']) ? $this->aSubClassNames['oProp'] : 'PluginTemplate_AdminPageFramework_Property_' . $this->_sStructureType;
