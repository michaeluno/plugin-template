...
if ( ! class_exists( 'PluginTemplate_Select2CustomFieldType' ) ) :
/**
 ...
 */
class PluginTemplate_Select2CustomFieldType extends PluginTemplate_AdminPageFramework_FieldType_select {
...
"jQuery( document ).ready( function(){
    ...
    var _initializeSelect2 = function( oNode ) {
        ...
        if ( _aOptions[ 'width' ] && 'auto' !== _aOptions[ 'width' ] ) {
            var _oFieldContainer = _oSelect2Target.closest( '.plugin-template-field-select2' );
            _oFieldContainer.css( 'width', _aOptions[ 'width' ] );
            _oFieldContainer.children( '.plugin-template-select-label' )
                .css( 'width', '100%' );
            _oFieldContainer.children( '.plugin-template-select-label' )
                .children( 'label' )
                .children( '.plugin-template-input-container' )
                .css( 'width', '100%' );
            _aOptions[ 'width' ] = '100%';
        }
        ...
        if ( _aOptions[ 'search_callback' ] ) {
             ...
             * Set inital values.
             */
            var _oInputForEncoded = _oSelect2Target.closest( '.plugin-template-field' )
            ...
            _oSelect2Target.on( 'change', function( event ){
                ...
                jQuery( this ).closest( '.plugin-template-field' )
                    .children( 'input[data-encoded]' ).first()
    ...
    protected function getStyles() {
        return "
.plugin-template-field-select2 .select2-container {     
    min-width: 200px;
    width: auto;
}

.plugin-template-field-select2 {
    max-width: 96%;
}

/* Make a room for repeatable buttons */
.repeatable .plugin-template-field-select2 > .plugin-template-select-label > label > .plugin-template-input-container {
    max-width: 84%;
}
