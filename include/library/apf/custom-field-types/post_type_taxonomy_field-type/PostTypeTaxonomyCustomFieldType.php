 ...
 * @package     PluginTemplate_AdminPageFramework
 */

if ( ! class_exists( 'PluginTemplate_PostTypeTaxonomyCustomFieldType' ) ) :
/**
 ...
 */
class PluginTemplate_PostTypeTaxonomyCustomFieldType extends PluginTemplate_AdminPageFramework_FieldType_taxonomy {
...
jQuery( document ).ready( function(){
    ...
    jQuery( '.plugin-template-checkbox-container-posttype[data-select_all_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_all_button_container\" onclick=\"jQuery( this ).selectAllPluginTemplate_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_all_button' ) + '</a></div>' );
    });            
    jQuery( '.plugin-template-checkbox-container-posttype[data-select_none_button]' ).each( function( iIndex ){
        jQuery( this ).before( '<div class=\"select_none_button_container\" onclick=\"jQuery( this ).deselectAllPluginTemplate_AdminPageFrameworkCheckboxes(); return false;\"><a class=\"select_all_button button button-small\">' + jQuery( this ).data( 'select_none_button' ) + '</a></div>' );
    });
    
    // When the post type check-boxes are clicked, show/hide the corresponding taxonomy elements.
    jQuery( document ).on( 'change', '.plugin-template-field-post_type_taxonomy .plugin-template-field-posttype input[type="checkbox"]', function() {
        ...
        var _oField              = jQuery( this ).closest( '.plugin-template-field-post_type_taxonomy' );
    ...
    jQuery( '.plugin-template-field-post_type_taxonomy .plugin-template-field-posttype input[type="checkbox"]:not(:checked)' ).each( function(){
        jQuery( this ).trigger( 'change' );
    } );
    

    jQuery().registerPluginTemplate_AdminPageFrameworkCallbacks( {
        /**
        ...
        repeated_field: function( oCloned, aModel ) {
            ...
            oCloned.find( '.plugin-template-field-posttype input[type="checkbox"]' )
                .prop( 'checked', false )
                .trigger( 'change' );         
...
.plugin-template-field-post_type_taxonomy .select_all_button_container, 
.plugin-template-field-post_type_taxonomy .select_none_button_container
{
...
.plugin-template-field-post_type_taxonomy .select-taxonomy-terms-checkbox-container {
            ...
            return "<div class='select-taxonomy-terms-checkbox-container'>"
                    . "<label class='select-taxonomy-terms'>"
                        ...
                        . "<input " . $this->getAttributes( $_aCheckboxAttributes ) . " />"
                            . __( 'Select taxonomy terms.', 'plugin-template-loader' )
                    . "</label>"
                . "</div>";
