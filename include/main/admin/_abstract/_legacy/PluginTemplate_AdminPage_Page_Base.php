 ...
 * @since    0.0.1
 */
abstract class PluginTemplate_AdminPage_Page_Base extends PluginTemplate_AdminPage_RootBase {
    ...
    public function __construct( $oFactory, array $aPageArguments ) {
        ...
        protected function _enqueueStyle() {
            $this->oFactory->enqueueStyle( 
                PluginTemplate_Registry::getPluginURL( 'main/asset/css/' . $this->sPageSlug . '.css' ),
                $this->sPageSlug
            );    
        }    
