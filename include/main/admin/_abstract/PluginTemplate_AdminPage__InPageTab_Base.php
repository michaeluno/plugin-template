 ...
 * @since       0.0.3
 */
abstract class PluginTemplate_AdminPage__InPageTab_Base extends PluginTemplate_AdminPage__Element_Base {
    ...
    protected function _doDebug( $oFactory ) {
        ...
        echo PluginTemplate_AdminPageFramework_Debug::getDetails(
