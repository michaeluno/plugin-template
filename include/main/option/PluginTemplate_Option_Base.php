 ...
 * @since    0.0.1
 */
class PluginTemplate_Option_Base extends PluginTemplate_PluginUtility {
    ...
    public function getDefaults() {
        return apply_filters(
            PluginTemplate_Registry::HOOK_SLUG . '_filter_default_options',
            PluginTemplate_Registry::$aOptions
        );
    }    
    ...
    public function hasUpgraded() {
        ...
        $_sCurrentVersion       = $this->_getVersionByDepth( PluginTemplate_Registry::VERSION );
